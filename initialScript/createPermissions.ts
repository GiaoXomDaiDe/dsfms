...
const DepartmentHeadModules = ['AUTH', 'PROFILES', 'DEPARTMENTS', 'COURSES', 'SUBJECTS', 'MEDIA']

const AcademicDepartmentModules = ['AUTH', 'PROFILES', 'ENROLLMENT', 'DEPARTMENTS', 'COURSES', 'SUBJECTS', 'MEDIA']
