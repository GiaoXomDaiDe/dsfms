...
export class CreatePermissioonBodyDTO extends createZodDto(CreatePermissionBodySchema) {}

export class UpdatePermissionBodyDTO extends createZodDto(CreatePermissionBodySchema) {}
